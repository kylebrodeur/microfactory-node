...
Since both Filesystem and Directory Snapshots are [Images](/docs/reference/modal.Image), you can delete them using the image deletion API. This is useful for managing storage or complying with data retention policies.
