...
2. Reference the published Image by name in Sandbox or Function code, getting the latest image built in 1 at the time

## Publishing an Image from a script

Use [`Image.build`](/docs/reference/modal.Image#build) to build the
...
Use [`Image.from_name`](/docs/reference/modal.Image#from_name) when referencing
...
to a [`Image.from_name`](/docs/reference/modal.Image#from_name) reference:
